...
# 웹사이트 열기
URL = 'https://www.dsu.ac.kr/kr/index.php?pCode=dsunoti2'
browser.get(url=URL)
browser.implicitly_wait(time_to_wait=10) # 로딩 끝날 때 까지 10초정도 기다림

# csv 파일 생성
file = open(r'/Users/user/Desktop/vscode 프로젝트/VSCODE 파이썬/동신대_공지사항_크롤링/NonUniversityNotice.csv', 'w', encoding='CP949', newline='')
